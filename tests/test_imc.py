...
class TestAUT(unittest.TestCase):
    def setUp(self):
        self.seq = os.path.join(PATH, 'tests', 'data', 'imc', 'sequence.fa')
        self.msa = os.path.join(PATH, 'tests', 'data', 'imc', 'msa.fa')
        self.tree = os.path.join(PATH, 'tests', 'data', 'imc', 'tree.newick')
        self.asr = os.path.join(PATH, 'tests', 'data', 'imc', 'asr.tsv')
        self.sim = os.path.join(PATH, 'tests', 'data', 'imc', 'sim.tsv')
        self.rm = ''
    ...
    def test_imc_seq_muscle_codeml(self):
        wd = os.path.join(PATH, 'tests', 'data', 'imc', 'simple')
        outs = ['ancestors.tsv', 'imc.counts.tsv', 'imc.details.tsv',
    ...
    def test_imc_seq_muscle_codeml_evolver_iqtree(self):
        wd = os.path.join(PATH, 'tests', 'data', 'imc', 'seq')
        outs = ['ancestors.tsv', 'imc.aut.txt', 'imc.counts.tsv',
                'imc.details.tsv', 'msa.fa', 'simulations.tsv',
                'trimmed.msa.fa']
    ...
    def test_imc_msa_codeml_evolver_iqtree(self):
        wd = os.path.join(PATH, 'tests', 'data', 'imc', 'msa')
        outs = ['ancestors.tsv', 'imc.aut.txt', 'imc.counts.tsv',
                'imc.details.tsv', 'simulations.tsv', 'trimmed.msa.fa']
    ...
    def test_imc_asr_evolver_iqtree(self):
        wd = os.path.join(PATH, 'tests', 'data', 'imc', 'asr')
        outs = ['imc.aut.txt', 'imc.counts.tsv',
                'imc.details.tsv', 'simulations.tsv']
    ...
    def test_imc_obs(self):
        ...
        outs = ['imc.counts.tsv', 'imc.details.tsv']
